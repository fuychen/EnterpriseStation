...
;(function(window) {
		...
		if( settings.tilt ) {
			...
			this.handleOrientation = function() {
				...
				requestAnimationFrame(function() {
					// Transform values.
					var movement = {ry:40},
						rotY = movement.ry / 180 * y - movement.ry;
	...
	Calendar.prototype._rotateCalendar = function(mousepos) {
		// Transform values.
		var movement = {rx:1, ry:1},
			rotX =  movement.rx / this.cubes.offsetHeight * mousepos.y - movement.rx,
			rotY =  movement.ry / this.cubes.offsetWidth * mousepos.x - movement.ry;
